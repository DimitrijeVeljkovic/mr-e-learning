...
describe('CourseService', () => {
  ...
  describe('api', () => {
    it('should call get all courses api', inject(
      [HttpClient],
      (http: HttpClient) => {
        jest.spyOn(http, 'get');
    ...
    it('should call get bookmarked courses api', inject(
    ...
    it('should call get in progress courses api', inject(
      [HttpClient, UserService],
      (http: HttpClient, userService: UserService) => {
        jest.spyOn(http, 'get');
        jest.spyOn(userService, 'getAuthData').mockReturnValue(mockAuthData);
    ...
    it('should call get single in progress course api', inject(
      [HttpClient, UserService],
      (http: HttpClient, userService: UserService) => {
        jest.spyOn(http, 'get');
        jest.spyOn(userService, 'getAuthData').mockReturnValue(mockAuthData);
        ...
        expect(http.get).toHaveBeenCalledWith(
          'http://localhost:8080/api/courses/in-progress/2?userId=1'
        );
      }
    ));

    it('should call get completed courses api', inject(
      [HttpClient, UserService],
      (http: HttpClient, userService: UserService) => {
        jest.spyOn(http, 'get');
        jest.spyOn(userService, 'getAuthData').mockReturnValue(mockAuthData);
        ...
        expect(http.get).toHaveBeenCalledWith(
          'http://localhost:8080/api/courses/finish?userId=1'
        );
      }
    ));

    it('should call start course api', inject(
      [HttpClient, UserService],
      (http: HttpClient, userService: UserService) => {
    ...
    it('should call bookmark course api', inject(
      [HttpClient, UserService],
      (http: HttpClient, userService: UserService) => {
        jest.spyOn(http, 'post');
        jest.spyOn(userService, 'getAuthData').mockReturnValue(mockAuthData);
    ...
    it('should call submit test api', inject(
      [HttpClient, UserService],
      (http: HttpClient, userService: UserService) => {
        jest.spyOn(http, 'post');
        jest.spyOn(userService, 'getAuthData').mockReturnValue(mockAuthData);
    ...
    describe('should call get counts api', () => {
      it('should call with user id', inject(
        [HttpClient],
        (http: HttpClient) => {
          jest.spyOn(http, 'get');
          service.getCounts('1');
          expect(http.get).toHaveBeenCalledWith(
            'http://localhost:8080/api/courses/count?userId=1'
          );
        }
      ));

      it('should call without user id', inject(
        [HttpClient],
        (http: HttpClient) => {
          jest.spyOn(http, 'get');
          service.getCounts(null);
          expect(http.get).toHaveBeenCalledWith(
            'http://localhost:8080/api/courses/count'
          );
        }
      ));
    });
